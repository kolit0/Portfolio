...
import Image2 from '../../images/grupo/gruponouma2.png';
import Image3 from '../../images/grupo/gruponouma3.png';
import Image4 from '../../images/gruponouma.png'
      ...
      <AnimatePresence initial={false} mode='wait'>
        <m.div key={`${slides[active]}-container`} className='bg-[#FFFBE9]  w-full relative overflow-hidden flex flex-col md:px-20 lg:px-40'>
          ...
          <div className='flex mt-2 flex-col sm:flex-row gap-3 sm:px-5'>
            ...
            <a href='https://www.gruponouma.com' target='_blank' className='flex items-center justify-center gap-2'>
